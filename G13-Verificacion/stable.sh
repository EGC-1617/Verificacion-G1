...
ENV_NAME="AgoraUS-G13-Verificacion"
URL_VIRTUAL_HOST="verifiacion.agoraus1.egc.duckdns.org"
BRANCH="stable"
...
CONF_TOMCAT_SERVER="$PATH_ROOT_HOST/continuous-delivery-playground/AgoraUS/G13-Verifiacion/stable-conf/tomcat7/server.xml"
