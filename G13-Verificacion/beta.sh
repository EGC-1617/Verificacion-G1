...
ENV_NAME="AgoraUS-G13-Verifiacion"
URL_VIRTUAL_HOST="beta.verificacion.agoraus1.egc.duckdns.org"
BRANCH="beta"
PROJECT_JENKINS_NAME="AgoraUS-G13-Verifiacion_make"

PATH_ROOT="/var/jenkins_home"
PATH_ROOT_HOST="/home/egcuser/jenkins_home"

CONF_TOMCAT_SERVER="$PATH_ROOT_HOST/continuous-delivery-playground/AgoraUS/G13-Verificacion/beta-conf/tomcat7/server.xml"
